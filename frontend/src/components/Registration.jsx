...
const Registration = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 pt-24 min-h-screen flex items-center justify-center">
      <div className="w-full max-w-lg bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl dark:shadow-gray-950/70 transition-colors duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            <HiUser className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 dark:text-gray-500" />
            <input
              type="text"
              name="name"
        ...
        >
            ...
            Continue to Home Feed (Skip Registration)
        </button>
